...
class Block_logic{
    ...
    func grp_block(){
        ...
        //reloading extension
        CXCallDirectoryManager.sharedInstance.reloadExtension(withIdentifier: "com.akshat.Bloket.Call-grp-blocking", completionHandler: {(error) -> Void in if let error = error {
